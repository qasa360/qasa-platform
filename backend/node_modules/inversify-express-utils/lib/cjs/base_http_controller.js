...
let BaseHttpController = class BaseHttpController {
    ...
    stream(readableStream, contentType, statusCode = http_status_codes_1.StatusCodes.OK) {
        return new results_1.StreamResult(readableStream, contentType, statusCode);
    }
};
...
exports.BaseHttpController = BaseHttpController = __decorate([
